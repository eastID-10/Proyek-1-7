...
<body class="body-nav">
  <div class="container-sm mt-5 ">
    ...
    <div class="container text-center mb-5">
      ...
      <button type="button" class="btn btn-outline-success" name="proses">Proses</button>
      <button type="button" class="btn btn-outline-dark" name="kirim">Kirim</button>
      <button type="button" class="btn btn-outline-warning" name="selesai">Selesai</button>
      <button type="button" class="btn btn-outline-danger" name="batal">Batal</button>
    </div>
